...
import com.west2.subactivity.activity.ActivityActivity;
import com.west2.subactivity.notice.NoticeActivity;
import com.west2.subactivity.property.PropertyActivity;
import com.west2.subactivity.setting.SettingActivity;
...
public class MainActivity extends Activity{
	...
	private void DarkItem(int position){
		...
		case 0:
			...
			txtNotice.setTextColor(mContext.getResources().getColor(R.color.grey_700));
			break;
		case 1:
			imgProperty.setImageDrawable(mContext.getResources().getDrawable(R.drawable.property_icon_1));
			txtProperty.setTextColor(mContext.getResources().getColor(R.color.grey_700));
			break;
		case 2:
			imgShop.setImageDrawable(mContext.getResources().getDrawable(R.drawable.shop_icon_1));
			txtShop.setTextColor(mContext.getResources().getColor(R.color.grey_700));
			break;
		case 3:
			imgActivity.setImageDrawable(mContext.getResources().getDrawable(R.drawable.activity_icon_1));
			txtActivity.setTextColor(mContext.getResources().getColor(R.color.grey_700));
			break;
		case 4:
			imgSetting.setImageDrawable(mContext.getResources().getDrawable(R.drawable.setting_icon_1));
			txtSetting.setTextColor(mContext.getResources().getColor(R.color.grey_700));
			break;
		}
	}
	private void LightItem(int position){
		...
		case 0:
			...
			txtNotice.setTextColor(mContext.getResources().getColor(R.color.blue_500));
			break;
		case 1:
			imgProperty.setImageDrawable(mContext.getResources().getDrawable(R.drawable.property_icon_2));
			txtProperty.setTextColor(mContext.getResources().getColor(R.color.blue_500));
			break;
		case 2:
			imgShop.setImageDrawable(mContext.getResources().getDrawable(R.drawable.shop_icon_2));
			txtShop.setTextColor(mContext.getResources().getColor(R.color.blue_500));
			break;
		case 3:
			imgActivity.setImageDrawable(mContext.getResources().getDrawable(R.drawable.activity_icon_2));
			txtActivity.setTextColor(mContext.getResources().getColor(R.color.blue_500));
			break;
		case 4:
			imgSetting.setImageDrawable(mContext.getResources().getDrawable(R.drawable.setting_icon_2));
			txtSetting.setTextColor(mContext.getResources().getColor(R.color.blue_500));
			break;
		}
	}

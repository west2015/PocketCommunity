...
public class MyShopActivity extends Activity{
	...
	private void ShowItem(int position){
		...
		switch(position){
		case 0:
			txtOrder.setTextColor(mContext.getResources().getColor(R.color.blue_500));
			...
			break;
		case 1:
			txtGood.setTextColor(mContext.getResources().getColor(R.color.blue_500));
...
//			actListGood.setLayoutParams(params);
			...
			break;
		case 2:
			txtAdd.setTextColor(mContext.getResources().getColor(R.color.blue_500));
	...
	private void HideItem(int position){
		...
		switch(position){
		case 0:
			txtOrder.setTextColor(mContext.getResources().getColor(R.color.grey_700));
			...
			break;
		case 1:
			txtGood.setTextColor(mContext.getResources().getColor(R.color.grey_700));
...
//			actListGood.setLayoutParams(params);
			...
			break;
		case 2:
			txtAdd.setTextColor(mContext.getResources().getColor(R.color.grey_700));
